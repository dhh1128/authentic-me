...
1. <a id="signatures">Signatures</a>: I will sign with my identifiers and their associated keys to prove I've seen content. If what I sign asserts something in my name, then my signature will further commit me to whatever semantics are embodied by that assertion.
...
1. <a id="cleanup">Cleanup</a>: I will rotate keys that I no longer use, revoke my signature over content that I decry, and repudiate things that are wrongly associated with me. 
...
1. <a id="publication">Publication</a>: I will keep an accurate, auditable, public record about all of this here, on this site and in independent [witnesses](witnesses-and-watchers.md).
